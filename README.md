...
![Reto Comprehensions](images/reto_comprehensions.png)

### Explicacion:
Segun tengo entendido es como si se pudieran crear colecciones de listas, conjuntos y diccionarios pero de forma mas rapida o algo asi y pues es mas rapido que estar creando fors para eso y solo con una linea de codigo se remplaza todo ese trabajo y ya

## Reflexion Personal
En lo que eh entendido del lenguaje es algo bastante bueno, facil y rapido de entender, todo funciona muy igual casi con las mismas caracteristicas, es entretenido y facil de lograr, pero siento que es algo confunso al inicio de igual manera me gusto poder poner a practica este tipo de estructuras